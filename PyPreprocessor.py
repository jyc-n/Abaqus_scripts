...
class InpFile:
    ...
    def writeInp3(self):
        ...
        with open(filename, 'w') as fout:
            ...
            # write boundary sets
            # centerline
            sets = self.geo.getCenterline()
            fout.write("*Nset, nset=Set-centerline, instance=Part-shell-1, generate\n"+
                       sets[0]+"\n")
            # left edge
            ...
            fout.write("*Nset, nset=Set-left, instance=Part-shell-1, generate\n"+
                       ...
                       sets[1]+"\n")
            # right edge
            sets = self.geo.getEdges("right")
            fout.write("*Nset, nset=Set-right, instance=Part-shell-1, generate\n"+
                       sets[0]+"\n"+
                       "*Elset, elset=Set-right, instance=Part-shell-1, generate\n"+
                       sets[1]+"\n")
            fout.write("*End Assembly\n") 
            ...
            fout.write("** Name: BC-left Type: Displacement/Rotation\n"+
                       "*Boundary\n"+
                       "Set-left, 1, 3\n")
            fout.write("** Name: BC-right Type: Displacement/Rotation\n"+
                       "*Boundary\n"+
                       "Set-right, 2, 3\n")
            ...
            fout.write("**\n"+
                       "**  LOADS\n"+
                       "**\n")
            # force on each node varies with #elements
            p = -0.1 / float(self.geo.getNWid())
            fout.write("** Name: Line Load   Type: Concentrated force\n"+
                       "*Cload\n"+
                       "Set-centerline, 3, "+"{:e}".format(p)+"\n")
            # fout.write("** Name: Line Load   Type: Concentrated force\n"+
            #            "*Cload\n"+
            #            "Set-centerline, 3, -0.1\n")
            fout.write("**\n"+
                       "**  OUTPUT REQUESTS\n"+
                       "**\n")
            fout.write("*Restart, write, frequency=0\n")
